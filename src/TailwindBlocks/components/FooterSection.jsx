...
export default function FooterSection() {
  return (
    <section>
      <footer className="text-TextLight body-font bg-BgColor">
        <div className="container px-5 py-5 mx-auto">
          <div className="flex flex-wrap md:text-left text-center -mb-10 -mx-4">
            <div className="lg:w-1/6 md:w-1/2 w-full px-4">
              <h2 className="title-font font-medium text-TextColor tracking-widest text-sm mb-3">
                CATEGORIES
              </h2>
              <nav className="list-none mb-10">
                <li>
                  <a className="text-TextLight hover:text-gray-800">
                    First Link
                  </a>
                </li>
                <li>
          ...
          <div className="container px-5 py-8 flex flex-wrap mx-auto items-center">
            <div className="flex md:flex-nowrap flex-wrap justify-center items-end md:justify-start">
              <div className="relative sm:w-64 w-40 sm:mr-4 mr-2">
                <label
                  for="footer-field"
                  className="leading-7 text-sm text-TextLight"
                >
                  Placeholder
                </label>
                <input
              ...
              <p className="text-TextLight text-sm md:ml-6 md:mt-0 mt-2 sm:text-left text-center">
            ...
            <span className="inline-flex lg:ml-auto lg:mt-0 mt-6 w-full justify-center md:justify-start md:w-auto">
              ...
              <a className="ml-3 text-TextLight">
                <svg
                  fill="currentColor"
                  stroke-linecap="round"
                  stroke-linejoin="round"
